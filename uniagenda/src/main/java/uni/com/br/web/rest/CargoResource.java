...
import uni.com.br.domain.Cargo;
import uni.com.br.repository.CargoRepository;
...
/**
 * REST controller for managing {@link uni.com.br.domain.Cargo}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class CargoResource {
    ...
    public ResponseEntity<Cargo> updateCargo(@RequestBody Cargo cargo) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, cargo.getId().toString()))
            .body(result);
    }
