...
public class CargoResourceIT {
    ...
    public void createCargo() throws Exception {
        ...
        // Create the Cargo
        restCargoMockMvc.perform(post("/api/cargos").with(csrf())
    ...
    public void updateCargo() throws Exception {
        ...
        restCargoMockMvc.perform(put("/api/cargos").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
    ...
    public void deleteCargo() throws Exception {
        ...
        // Delete the cargo
        restCargoMockMvc.perform(delete("/api/cargos/{id}", cargo.getId()).with(csrf())
